    ...
    <div class="row">
      <div class="col-xs-12">
        <ul>
          ...
          <li><a href="#" class="change-category" data-category_id="24">Tradeshows</a></li><li> | </li>
          <li><a href="#" class="change-category" data-category_id="25">Folders/Binders</a></li><li> | </li>
          <li><a href="#" class="change-category" data-category_id="28">Ad Specialty</a></li>
        </ul>
      </div>
    </div>
  </div>
