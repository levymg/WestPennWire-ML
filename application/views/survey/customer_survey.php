        ...
        <div class="col-lg-12 form-2">
            <legend>
                ...
                <div class="form-group">
                        <div class="col-xs-12">
                            <div class="question">
                                <p>6.  Fiber Optic cable accounts for what percentage of your cable footage used?</p>
                            </div>
                        </div>
                         <div class="col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-xs-12">
                           <ul class="list-group" id="fiber">
                            <li class="list-group-item list-group-item-success single toggle" data-name="cable" data-value="Less Than 10%">
                                Less Than 10%
                            </li>
                            <li class="list-group-item list-group-item-success single toggle" data-name="cable" data-value="10%-25%">
                ...
                <div class="form-group">
                        <div class="col-xs-12">
                            <div class="question">
                                <p>7. Is there anything else we should know about your needs for wire and cable products and solutions?</p>
                            </div>
                        </div>
